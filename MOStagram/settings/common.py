"""
Django settings for MOStagram project.
...
SECRET_KEY = "u_qky%tfp&)&kkdl4luetye%4&z^08np1n&mtbea_u_z&^5))y"
...
ROOT_URLCONF = "MOStagram.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, "MOStagram", "templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "MOStagram.wsgi.application"
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "MOStagram", "static"),
]
